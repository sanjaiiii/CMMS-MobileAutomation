...
;		
		...
		List<WebElement> checkmark = pd.findElements(By.xpath("//*[@id=\"id_div_savedassets\"]/div[1]/span/label/span")); // Locate the checkboxes within the parent div
		...
		for (WebElement cm : checkmark) {
			try {
		        ...
		        System.out.println("Checkbox not clickable: " + e.getMessage());
		    } catch (Exception e) {
